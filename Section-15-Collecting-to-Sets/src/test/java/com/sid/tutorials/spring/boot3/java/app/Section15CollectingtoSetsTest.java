 ...
 */
@SpringBootTest(classes = Section15CollectingtoSets.class)
class Section15CollectingtoSetsTest {
    @Autowired
    ...
    public void distinctValue(){
        Set<Integer> distinctValue = streamDistinct.StreamDistinctValueUsingSet();
