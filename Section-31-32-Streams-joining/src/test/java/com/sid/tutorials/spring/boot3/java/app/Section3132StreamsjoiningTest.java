...
import com.sid.tutorials.spring.boot3.java.app.Test.Streamsjoining;
 ...
 */
@SpringBootTest(classes = Section3132Streamsjoining.class)
class Section3132StreamsjoiningTest {
    @Autowired
    private MockDataPrep mockDataPrep;

    @Autowired
    private Streamsjoining streamsjoining;
    ...
    @Test
    void getJoined(){
        System.out.println(streamsjoining.getJoinValue());
    }
}