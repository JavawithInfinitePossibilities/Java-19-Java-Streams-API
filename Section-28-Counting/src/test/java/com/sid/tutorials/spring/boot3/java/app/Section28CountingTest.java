...
import com.sid.tutorials.spring.boot3.java.app.Test.StreamCounting;
 ...
 */
@SpringBootTest(classes = Section28Counting.class)
class Section28CountingTest {
    @Autowired
    private MockDataPrep mockDataPrep;

    @Autowired
    private StreamCounting  streamCounting;
    ...
    void groupingbyTest() {
        try {
            System.out.println(streamCounting.getCountingByName());
        } catch (IOException e) {
            throw new RuntimeException(e);
        }
    }
