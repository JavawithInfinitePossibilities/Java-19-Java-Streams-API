...
import com.sid.tutorials.spring.boot3.java.app.Test.IntStreamsRangeRangeClosed;
 ...
 */
@SpringBootTest(classes = Section09IntStreamsRangeRangeClosed.class)
class Section09IntStreamsRangeRangeClosedTest {
    @Autowired
    private MockDataPrep mockDataPrep;

    @Autowired
    private IntStreamsRangeRangeClosed rangeRangeClosed;
    ...
    @Test
    void getRangeTestUsingStream() {
        rangeRangeClosed.range();
    }
}