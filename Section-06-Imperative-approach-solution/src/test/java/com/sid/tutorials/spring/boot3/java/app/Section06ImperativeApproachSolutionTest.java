...
import com.sid.tutorials.spring.boot3.java.app.task.ImperativeApproach;
 ...
 */
@SpringBootTest(classes = Section06ImperativeApproachSolution.class)
class Section06ImperativeApproachSolutionTest {
    @Autowired
    private MockDataPrep mockDataPrep;

    @Autowired
    private ImperativeApproach imperativeApproach;
    ...
    @Test
    public void getyoungPeopleTest() throws IOException {
        List<Person> people = imperativeApproach.getPeople();
