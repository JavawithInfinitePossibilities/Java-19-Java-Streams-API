...
import com.sid.tutorials.spring.boot3.java.app.Test.MappingtoDoublesExerciseSolution;
 ...
 */
@SpringBootTest(classes = Section18MappingtoDoublesExerciseSolution.class)
class Section18MappingtoDoublesExerciseSolutionTest {
    @Autowired
    private MockDataPrep mockDataPrep;

    @Autowired
    private MappingtoDoublesExerciseSolution mappingtoDoublesExerciseSolution;
    ...
    void mappingtoDoublesExerciseSolutionTest() {
        try {
            System.out.println(mappingtoDoublesExerciseSolution.getAveragePriceOfCar());
        } catch (IOException e) {
            throw new RuntimeException(e);
        }
    }
