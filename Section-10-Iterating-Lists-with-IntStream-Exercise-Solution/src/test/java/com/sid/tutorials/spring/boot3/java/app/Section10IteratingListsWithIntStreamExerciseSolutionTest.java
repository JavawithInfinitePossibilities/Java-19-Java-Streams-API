...
import com.sid.tutorials.spring.boot3.java.app.Test.IteratingListsWithIntStreamExerciseSolution;
 ...
 */
@SpringBootTest(classes = Section10IteratingListsWithIntStreamExerciseSolution.class)
class Section10IteratingListsWithIntStreamExerciseSolutionTest {
    @Autowired
    private MockDataPrep mockDataPrep;

    @Autowired
    private IteratingListsWithIntStreamExerciseSolution intStreamExerciseSolution;
    ...
    void iteratorRangeTest(){
        try {
            intStreamExerciseSolution.rangeIterator();
        } catch (IOException e) {
            throw new RuntimeException(e);
        }
    }
