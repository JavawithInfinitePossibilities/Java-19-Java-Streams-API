...
import com.sid.tutorials.spring.boot3.java.app.Test.StreamFlatmap;
 ...
 */
@SpringBootTest(classes = Section30Flatmap.class)
class Section30FlatmapTest {
    @Autowired
    private MockDataPrep mockDataPrep;

    @Autowired
    private StreamFlatmap streamFlatmap;
    ...
    @Test
    void getFlatMapTest() {
        System.out.println(streamFlatmap.getFlatmap());
    }
}