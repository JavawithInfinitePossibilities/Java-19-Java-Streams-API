...
import com.sid.tutorials.spring.boot3.java.app.Test.StreamfindFirstAndAnyDiff;
 ...
 */
@SpringBootTest(classes = Section21ThedifferencebetweenfindAnyandfindFirst.class)
class Section21ThedifferencebetweenfindAnyandfindFirstTest {
    @Autowired
    private MockDataPrep mockDataPrep;

    @Autowired
    private StreamfindFirstAndAnyDiff streamfindFirstAndAnyDiff;
    ...
    void streamfindFirst() {
        System.out.println(streamfindFirstAndAnyDiff.getStreamfindFirstAnyDiff());
    }

    @Test
    void streamfindAny() {
        System.out.println(streamfindFirstAndAnyDiff.getStreamfindAny());
    }
}