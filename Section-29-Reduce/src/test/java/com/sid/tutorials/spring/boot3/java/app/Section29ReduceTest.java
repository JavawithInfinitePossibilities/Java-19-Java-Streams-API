...
import com.sid.tutorials.spring.boot3.java.app.Test.StreamReduce;
 ...
 */
@SpringBootTest(classes = Section29Reduce.class)
class Section29ReduceTest {
    @Autowired
    private MockDataPrep mockDataPrep;

    @Autowired
    private StreamReduce streamReduce;
    ...
    void streamReduceTest(){
        try {
            System.out.println(streamReduce.StreamReduce());
        } catch (IOException e) {
            throw new RuntimeException(e);
        }
    }
