...
import com.sid.tutorials.spring.boot3.java.app.Test.FilteringWithStreams;
 ...
 */
@SpringBootTest(classes = Section16FilteringWithStreams.class)
class Section16FilteringWithStreamsTest {
    @Autowired
    private MockDataPrep mockDataPrep;

    @Autowired
    private FilteringWithStreams filteringWithStreams;
    ...
    @Test
    void getCarByValueTest() {
        try {
            filteringWithStreams
                    .getCarDetailsByValue()
                    .stream()
