...
import com.sid.tutorials.spring.boot3.java.app.Test.IntStreamIterate;
 ...
 */
@SpringBootTest(classes = Section11IntStreamIterate.class)
class Section11IntStreamIterateTest {
    @Autowired
    private MockDataPrep mockDataPrep;

    @Autowired
    private IntStreamIterate intStreamIterate;
    ...
    @Test
    void iteratorWith3Parameters() {
        try {
            intStreamIterate.iteratorRange();
        } catch (IOException e) {
            throw new RuntimeException(e);
        }
    }
